        ...
        <div class="display">
          ...
          <div className="mt-8 flex space-x-4">
            ...
            <button
              ...
              onClick={() => handleRedirect('https://www.instagram.com/peterthetran/')}
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
            ...
            <button
              ...
              onClick={() => handleRedirect('https://www.linkedin.com/in/peter-tran-portal/')}
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <button
              ...
              onClick={() => handleRedirect('https://www.youtube.com/@MystTypes')}
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <button
              ...
              onClick={() => handleRedirect('https://github.com/aeMyst')}
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
          ...
          <div className="mt-8">
            <button
              class="Resume-button"
              onClick={() => handleRedirect('https://drive.google.com/file/d/1bWtWvKft1TV327cjGLRy0AoiLZAeVwfO/view?usp=sharing')}
            >
              Resume
            </button>
          </div>
